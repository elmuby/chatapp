      ...
      <div className="flex w-1/2 items-center justify-center bg-amber-100">
        <div className="max-w-md w-full p-8 bg-white rounded lg shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <button
              onClick={handleLogin}
              className="w-full bg-red-400 rounded-full shadow-lg hover:bg-red-200"
            >
              Login with Google
            </button>
            ...
            <button className="w-full bg-black rounded-full shadow-lg hover:bg-gray-700 text-white">
              Login with Twitter
            </button>
          </div>
        </div>
